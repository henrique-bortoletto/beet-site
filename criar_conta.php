    ...
    <body>	
            ...
            <div class="container">				
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav"><a href="index.html">Entrar</a><span class="lnr lnr-arrow-right"></span><a href="#">Criar Conta</a></p>
                    </div>	
                </div>
            </div>
        </section>
        ...
        <div class="container">
            <div class="section-top-border">
                <h3 class="mb-30 text-center mt-40">Complete os seus dados</h3>
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6 col-md-8">
                        ...
                        <form action="cadastrar_usuario.php" method="POST">
                            <div class="mt-20">
                                <input type="text" name="nome" placeholder="Nome ou usuário" required class="single-input-primary">
                            </div>
                            <div class="mt-20">
                                <input type="text" name="email" placeholder="E-mail" required class="single-input-primary">
                            </div>
                            <div class="mt-20">
                                <input type="password" name="senha" placeholder="Senha" required class="single-input-primary">
                            </div>
                            <div class="mt-20">
                                <input type="password" name="r_senha" placeholder="Repetir Senha" required class="single-input-primary">
                            </div>
                            <div class="button-group-area mt-20">
                                <button type="submit" class="genric-btn info e-large">Criar Conta</button>
                                <a href="logar.php" class="ml-50"><span class="lnr lnr-arrow-left"></span>  Voltar</a>
                            </div>
                        </form>
                    </div>
                </div>
